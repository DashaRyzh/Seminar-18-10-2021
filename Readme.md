...
Чтобы запушить текущую ветку в удалённую ветку используется команда *git push*, для загрузки истории и изменений удалённой ветки и произведения слияния с текущей веткой используется команда *git pull*.